 ...
 * Klasse Client
 * </p>
 * Ein Client kann &uuml;ber das Netz die Verbindung zu einem Server herstellen.
 * <br>
...
public abstract class Client {
    ...
    /**
     * Hilfsklasse fuer den Client, die in einem eigenen Thread den Empfang
     * einer Nachricht vom Server realisiert.
     *
    ...
    class Clientempfaenger extends Thread {
        ...
        /**
         * Der ClientEmpfaenger hat den zugeh&ouml;rigen Client und die
         * zugeh&ouml;rige Connection kennen gelernt.<br>
         *
         * @param pClient     zugeh&ouml;riger Client, der die einkommenden Nachrichten
         *                    bearbeitet
         * @param pConnection zugeh&ouml;rige Connection, die die einkommenden
         *                    Nachrichten empf�ngt
         */
        ...
        /**
         * Solange der Server Nachrichten sendete, wurden diese empfangen und an
         * die ClientVerbinedung weitergereicht.
         */
        public void run() {
            String lNachricht;
